...
_FIELD_DEFINITIONS: Dict[str, Dict[str, Any]] = {
    ...
    "LLM_AUTH_MODE": {
        "title": "LLM Auth Mode",
        "description": "Choose authentication mode: api_key or browser_cli.",
        "category": "ai_model",
        "data_type": "string",
        "ui_control": "select",
        "is_sensitive": False,
        ...
        "options": ["api_key", "browser_cli"],
        "validation": {"enum": ["api_key", "browser_cli"]},
        "display_order": 31,
    },
    "LLM_BROWSER_CLI_COMMAND": {
        "title": "Browser CLI Command",
        "description": "CLI command used in browser_cli mode (for example: codex).",
        "category": "ai_model",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
    ...
    "LLM_BROWSER_CLI_MODEL": {
        "title": "Browser CLI Model",
        "description": "Preferred model in browser_cli mode. Empty means OPENAI_MODEL.",
        "category": "ai_model",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
    ...
    "LLM_BROWSER_CLI_TIMEOUT_SEC": {
        "title": "Browser CLI Timeout Seconds",
        "description": "Timeout for each browser_cli request.",
        "category": "ai_model",
        "data_type": "integer",
        "ui_control": "number",
        "is_sensitive": False,
    ...
    "LLM_BROWSER_CLI_AUTO_LOGIN": {
        "title": "Browser CLI Auto Login",
        "description": "Try login command automatically when auth check indicates not logged in.",
        "category": "ai_model",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
    ...
    "LLM_BROWSER_CLI_LOGIN_COMMAND": {
        "title": "Browser CLI Login Command",
        "description": "Login command for browser auth (for example: codex login).",
        "category": "ai_model",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
        "is_required": False,
        "is_editable": True,
        "default_value": "codex login",
        "options": [],
        "validation": {},
        "display_order": 36,
    },
    "LLM_BROWSER_CLI_AUTH_CHECK_COMMAND": {
        "title": "Browser CLI Auth Check Command",
        "description": "Command used to verify login status before model call.",
        "category": "ai_model",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
        "is_required": False,
        "is_editable": True,
        "default_value": "codex login status",
        "options": [],
        "validation": {},
        "display_order": 37,
    },
    "LLM_BROWSER_CLI_ALLOW_APIKEY_FALLBACK": {
        "title": "Allow API Key Fallback",
        "description": "Allow fallback to API key providers when browser_cli request fails.",
        "category": "ai_model",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
